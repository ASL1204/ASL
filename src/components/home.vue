<template>
  ...
  <div>
    ...
    <div class="slideshow-container">
      <div class="mySlides fade" v-for="(image, index) in images" :key="index" :class="{ active: slideIndex === index + 1 }">
    ...
    <ul class="el-carousel__indicators el-carousel__indicators--horizontal">
      <li v-for="(image, index) in images" :key="index" :class="{ 'is-active': slideIndex === index + 1 }">
...
export default {
  ...
  setup() {
    ...
    const showSlides = (n) => {
      ...
      slides[slideIndex.value - 1].classList.add("active");
      dots[slideIndex.value - 1].classList.add("is-active");
    };
